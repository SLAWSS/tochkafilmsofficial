...
class Command(BaseCommand):
    help = 'Обновление постера для фильма "Джон Уик 4"'

    def handle(self, *args, **options):
        self.stdout.write("🔫 ОБНОВЛЕНИЕ ПОСТЕРА 'ДЖОН УИК 4'")
        self.stdout.write("=" * 45)
        
        # URL постера с Google Images
        poster_url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ9QlCCHeiqT8Yw0r1BQQt1ffjNAH-z5CpxVw&s'
        
        try:
            # Ищем фильм
            film = Film.objects.get(title='Джон Уик 4')
            ...
            # Сохраняем постер
            filename = "john_wick_4_2023_google.jpg"
            ...
            self.stdout.write(f"🔫 Финальная глава")
            ...
            self.stdout.write(self.style.ERROR('❌ Фильм "Джон Уик 4" не найден'))
